                ...
                <div className={styles["form-sigin"]}>
                    <form action="">
                        <div className={styles["demo"]}>
                            ...
                            <input style={{width:"288px",height:"46px", border:"1px solid #FFFFFF",borderBottom:"1px solid rgb(132, 146, 146)"}} type="text" name="" id="" placeholder="Đăng Nhập" />
                    ...
                    <div className={styles["form2"]}>
                        <h1 style={{color:"#FFFFFF"}}>Start your journey now</h1>
