...
import loadingok from "../../assets/loading/Bean Eater@1x-1.0s-200px-200px.svg"
import { ClipLoader } from "react-spinners";

// interface ()

export const Amthanh = () => {
    const [product, setProduct] = useState<any[]>([]);
    const [sort,setSord] = useState<boolean | undefined>(undefined);
    ...
    useEffect(() => {
        const fetchApi = async () => {
            ...
            //   replace: dùng để loại bỏ các dấu . ở chuỗi
      ...
      const sortProduct = (descending : boolean) => {
        setLoading(true)
        setTimeout(() => {
        ...
        <><div style={{paddingTop:"65px"}} className={styles["container"]}>
             ...
             <div className={styles["header"]}>
                    ...
                    <div className={styles["filllter"]}>
                        <div onClick={()=> sortProduct(false)} className={styles["fillter2"]}
                        
                        style={{
                            border: sort === false ? '1px solid red' : '',
                            color: sort === false ? 'red' : ''
                        }}
                        >
                        ...
                        <div onClick={()=> sortProduct(true)} className={styles["fillter2"]}
                        style={{
                            border: sort ?  '1px solid red':'',
                            color: sort ? 'red' :'' 
                        }}
                        >
                            <svg height="15" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                ...
                <div className={styles['product']}>
                    {product.filter(product => product.current === "amthanh").slice(0, 6).map((items) => {
                            ...
                            <div className={styles['items_product']}
                                ...
                                <a href="">
                                    ...
                                    <div className={styles['items-product-text']}>
                                        <p>{items.name}</p>
                                        <span className={styles['price-product']}>{items.price.toLocaleString()} đ</span>
